...
class PackageManagerHelperTest {
    ...
    companion object {
        ...
        private val YANDEX_APPLICATION_1 = createApplicationInfo("package2", 1, 2, null)

        private val YANDEX_APPLICATION_2 = createApplicationInfo("package3", 2, 3, null)

        private val YANDEX_APPLICATION_3 = createApplicationInfo("package3", 2, 3, 1)
